...
public class SkillPlayerScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (player.GetComponent<PickupItems>().coinCounterInt < 10)
            {
            ...
            if (player.GetComponent<PickupItems>().coinCounterInt < 5)
            {
    ...
    public void AddHealth()
    {
        if (player.GetComponent<PickupItems>().coinCounterInt >= 5)
        {
            player.GetComponent<PickupItems>().coinCounterInt -= 5;
            player.GetComponent<PlayerHealth>().currnetHealth += 10;
    ...
    public void RestoreHealth()
    {
        if (player.GetComponent<PickupItems>().coinCounterInt >= 10)
        {
            player.GetComponent<PickupItems>().coinCounterInt -= 10;
            player.GetComponent<PlayerHealth>().currnetHealth = 100;
