...
public class PlayerShooting : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && bulletMagazineNumber > 0)
        {
            ...
            { 
                gunAnimator.SetBool("GunRecoil", true);
    ...
    {
        IsAvailable = false;
        gunAnimator.SetBool("GunReload", true);
        yield return new WaitForSeconds(reloadTime);
        gunAnimator.SetBool("GunReload", false);
        IsAvailable = true;
    }
